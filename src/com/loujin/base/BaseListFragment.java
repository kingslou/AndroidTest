...
import com.loujin.bean.Entity;
import com.loujin.bean.ListEntity;
import com.loujin.cache.CacheManager;
import com.loujin.ui.empty.EmptyLayout;
import com.loujin.utils.StringUtils;
import com.loujin.utils.TDevice;
...
//        }
    ...
    protected boolean compareTo(List<? extends com.loujin.bean.Entity> data, com.loujin.bean.Entity enity) {
        int s = data.size();
        if (enity != null) {
            for (int i = 0; i < s; i++) {
