...
import com.loujin.api.ApiHttpClient;
import com.loujin.dao.DaoMaster;
...
public class AppContext extends BaseApplication {
    ...
    private volatile static DaoMaster daomaster=null;
    
    private volatile static  DaoSession daosession=null;
    ...
    public static DaoMaster getDaoMaster(){
    	if(daomaster==null){
    		synchronized (AppContext.class) {
    			if(daomaster==null){
    				DaoMaster.OpenHelper helper = new DaoMaster.DevOpenHelper(context(),AppConfig.DB_Name, null);
