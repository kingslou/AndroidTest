...
import com.loujin.utils.TLog;

public class ApiHttpClient {

    public final static String HOST = "http://api.yi18.net/";
    private static String API_URL = "http://api.yi18.net/%s";
    ...
    public static void setHttpClient(AsyncHttpClient c) {
        ...
        client.addHeader("User-Agent", "Mozilla/5.0 (Windows NT 6.2; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/38.0.2125.111 Safari/537.36");
